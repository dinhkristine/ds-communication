...
# CD plot
par(mfrow=c(1,2))
cdplot(factor(good)~distance, 
       ylab="Successful field goal", xlab="Field goal attempt distance")
cdplot(factor(good)~change, 
       ylab="Successful field goal", xlab="Field goal results in lead change")
